...
?>
<section class="payment_page mt-4">
 <div class="container">
   <div class="row">
      ...
      <div class="card-body">
       <?php
          if(isset($_SESSION['buy_now']) && isset($_SESSION['product_id'])){
              ...
              $query="SELECT products.*,sellers.shop_name FROM products INNER JOIN sellers ON products.seller_id=sellers.seller_id WHERE product_id='$product_id'";
        ...
        <div class="row d-flex justify-content-start" style="margin: 0;">
          ...
          <div class="col-8 col-md-9 col-lg-10">
              ...
              <h6 class="text-muted product-seller">Seller: <?php echo $row1['shop_name'] ?></h6> 
              <h4 class="product-price"> <span class="main-price">₹<?php $x=$row1['product_price'];$y=$row1['product_discount']; $money=($x-($x*$y)/100); echo $money; ?></span> <del class="text-muted">₹<?php echo $row1['product_price']; ?></del> <span class="text-success discount"><?php echo $row1['product_discount']; ?>% off</span></h4>
          </div>
        </div>   
    <?php
      }
         ...
         <script>
           ...
           <form action="../../src/server/order_detail.php" method="post">
              <div class="form-group">
                 ...
                 <div class="form-check form-check">
                   <a href="../../../paytm/TxnTest.php">Paytm</a>
                 </div>
...
<div class="col-sm-4">
        <div class="card">
           ...
           <div class="card-body">
               <p><span class="float-left">Price</span><span class="float-right"><?php if(isset($money)){echo $money;} ?></span></p><br>
               <p><span class="float-left">Delivery Charge</span> <span class="float-right">Free</span></p><br>
               <p><span class="float-left">Total Payable</span> <span class="float-right"><?php if(isset($money)){echo $money;} ?></span></p>
           </div>
        </div>
     </div>
