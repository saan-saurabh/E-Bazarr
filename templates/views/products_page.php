...
<?php  $index="../../index.php"; $path="../../"; include "../includes/productCategoryNav.php" ?>
<!--Product Page Start-->  
       ...
       <div class="col-lg-2 filter hide-on-small">
         ...
         <div class="card">
            ...
            <div class="card body">
              ...
              <ul>
                <a href="<?php $_SERVER['PHP_SELF'] ?>?product_key=<?php echo $_REQUEST['product_key']?> && sortKey=lh"><li>Price low to high</li></a>
                <a href="<?php $_SERVER['PHP_SELF'] ?>?product_key=<?php echo $_REQUEST['product_key']?> && sortKey=hl"><li>Price high to low</li></a>
              </ul>
            </div>
         </div>
           ...
           <div class="card-body">
             ...
             <?php
              ...
              if(isset($_REQUEST['sortKey'])){
                if($_REQUEST['sortKey']=='lh'){
                  $query="SELECT * FROM products WHERE product_cat='$category' ORDER BY product_price ASC";
                }
                else if($_REQUEST['sortKey']=='hl'){
                  $query="SELECT * FROM products WHERE product_cat='$category' ORDER BY product_price DESC";
                }
              }
              else{
              ...
              <div class="col-6 col-md-4 col-lg-3">
               <div class="card">
                 ...
                 <div class="card-footer">
                   ...
                   <a href="../../src/server/add_to_cart.php?product_key=<?php echo $row['product_id']; ?>"><button class="btn btn-primary w-100 mt-1">Add To Card</button></a>
                 </div>
               </div>
              </div>
