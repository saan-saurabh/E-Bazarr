<?php session_start();  ?>
<?php include "../../src/db_con2.php" ?>
<?php
$em=$_SESSION['seller_email'];
?>

<?php include "../includes/header.php" ?>
<?php $index="../../index.php"; $path="../../"; include "../includes/navbar.php" ?>
<?php include "../../src/server/product.php" ?>
<?php 


if(isset($_POST["submit"])){
  $product = new Product();
  $product->set_seller_id((int)$_SESSION["seller_id"]);
    ...
    <div class="row">
       <div class="col-lg-2">
         ...
         <div class="card">
            ...
            <h5>My Profile</h5>
            <a href="#" data-toggle="modal" data-target="#seller_info_edit"><button class="btn btn-warning btn-sm"><strong><i class="fa fa-edit"></i></strong></button></a>
            </div>
...
?>
 ...
 <!--Product Section Start-->    
       <div class="col-12 col-lg-10 product_sec">      
         <div class="card">
             <div class="card-header p-2" style="display:flex; justify-content:space-between;">
                 <div><h5><?php echo $action=="add-item"?"Add Product Details":"Listed Items";?></h5></div>
                <!-- <button class="btn btn-warning text-right"><a href="#" data-toggle="modal" data-target="#AddItems"><strong>Add Items</strong></a></button> -->
                <a href="?action=<?php echo $action =="add-item"?"display-item":"add-item" ; ?>" >
                <button class="btn btn-warning text-right">
                <strong><?php echo $action=="add-item"?"Display Items":"+";?></strong>
                </button>
             </a>
                 </div>
